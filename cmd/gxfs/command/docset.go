...
func requireDocsetClient(cli *client.Client) error {
	...
	return fmt.Errorf("docset commands require a configured gxfs server connection")
}
...
Example:
  gxfs docset add best-practices /go-errors.md --source repo://openai-go/errors.md`,
